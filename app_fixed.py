...
.message { max-width: 800px; margin: 20px auto; padding: 20px; 
           background: rgba(255,255,255,.05); border-radius: 12px; text-align: center; }
</style></head>
<body>
<div class="topbar">
...
<div class="upload-section">
  <div class="upload-zone">
    ...
    <h3>BigSeller 超材分單功能</h3>
    <p>上傳 BigSeller 訂單 Excel 檔案，自動分析超材情況</p>
    <button class="btn-upload">📁 選擇檔案 (開發中)</button>
  </div>
</div>
<div class="message">
  <h4>🚧 功能開發中</h4>
  <p>BigSeller 超材分單功能正在開發中，敬請期待！</p>
  <p>預計功能：自動判斷不可拆單/可拆單，一鍵複製標記清單</p>
</div>
</body></html>''')
